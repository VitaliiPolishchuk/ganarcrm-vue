  ...
  mutations: {
    initializeStore(state) {
      if (localStorage.getItem("token")) {
        ...
        state.user.id = parseInt(localStorage.getItem("userid"));
        state.team.name = localStorage.getItem("team_name");
        state.team.id = parseInt(localStorage.getItem("team_id"));
        state.team.plan = localStorage.getItem("team_plan");
        state.team.max_leads = parseInt(localStorage.getItem("team_max_leads"));
        state.team.max_clients = parseInt(
